    ...
    if (questions.length === 0) {
        return (
            <div className='flex items-center justify-center min-h-screen'>
                <ClipLoader color={'#ffffff'} loading={questions.length === 0} size={150} />
            </div>
        );
    }
    ...
    return (
        <CenteredContainer>
            <div className=' w-full flex flex-col items-center justify-center min-h-screen'>
                <Title level={2} className={`notosans-kr text-white mb-8 text-6xl`}>
                    오늘의 퀴즈
                </Title>
                <div className='w-full flex flex-col items-center justify-center' style={{ maxWidth: '600px' }}>
                    ...
                    <div className='flex flex-col notosans-kr items-center space-y-8 mb-48'>
                        <div
                        ...
                        <span className='text-4xl notosans-kr text-[#9796AE]'>vs</span>
                        <div
                            onClick={() => handleNextQuestion(1)}
                            className='w-full cursor-pointer notosans-kr py-8 bg-gradient-to-r text-center from-[#30459D] via-[#673f81] to-[#874280] text-white font-semibold rounded-lg shadow-lg'
                            style={{
                                fontSize: '1.5rem',
                                width: '100%',
                                maxWidth: '500px',
