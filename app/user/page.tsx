...
const UserProfilePage = () => {
    ...
    return (
        <CenteredContainer>
            <div className='flex flex-col notosans-kr items-center justify-center min-h-screen'>
                <div className='bg-[#1D203E] p-8 text-white w-full max-w-md'>
                    <div className='flex flex-col items-center'>
                        <Title level={2} className='text-5xl text-white mb-8'>
                            마이페이지
                        </Title>
                        <AvatarImage
                            ...
                            width={null}
                            height={null}
                            className='rounded-xl mb-24 bg-gradient-to-b from-[#14183F] to-[#2C1E45] mt-8 pt-4'
                        />
                    ...
                    <div className='w-full fixed bottom-0 left-0 right-0 flex justify-center bg-[#1D203E]'>
                        <button
                            ...
                            className='notosans-kr bg-gradient-to-b from-[#31376F] to-[#894BA2] h-20 hover:bg-[#6858c5] py-6 text-white text-center text-2xl font-bold  px-4  w-full max-w-md'
                        >
                            변경하기
                        </button>
                    </div>
